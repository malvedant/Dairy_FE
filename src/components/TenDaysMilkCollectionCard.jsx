...
const TenDaysMilkCollectionCard = () => {
    ...
    const handleSubmit = async () => {
        setLoading(true);
        try {
            const { data } = await axios.post("https://dairy-be-1.onrender.com/api/D_owner/ten-days-dairyOwner-milkCollection", {
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colSpan="5" style={{ height: "40px", fontWeight: "bold", textAlign: "left", fontSize: "16px" }}>
                                        {t("final_total_milk_price")}: ₹{totalMilkPrice}, {t("final_total_milk_count")}: {totalMilkCount} Liters
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
export default TenDaysMilkCollectionCard
