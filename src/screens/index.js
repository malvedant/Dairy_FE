...
import UpdateCowFeed from '../components/modals/UpdateCowFeed';
import AllocateCowFeed from './AllocateCowFeed';
import AdvancePayment from './AdvancePayment';
import FarmersList from './farmersList';
import AddFarmers from './AddFarmers';
import SetMilkPrice from './setMilkPrice';
import AddMilkCount from './AddMilkCount';
import AddNewCowFeed from './AddNewCowFeed';
